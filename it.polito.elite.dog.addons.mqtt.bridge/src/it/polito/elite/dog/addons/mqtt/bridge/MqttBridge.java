...
public class MqttBridge implements EventHandler, ManagedService
{
    ...
    public void handleEvent(Event event)
    {
        ...
        if ((this.bridgeStates) && (event.getTopic()
        ...
        if ((this.bridgeNotifications) && (event.getTopic().startsWith(
                "it/polito/elite/dog/core/library/model/notification/")))
        {
            // handle notifications
            ...
            throws ConfigurationException
    {
        ...
        if ((properties != null) && (!properties.isEmpty()))
        {
            ...
            for (String brokerAddress : this.brokerAddresses)
            {
                ...
                stateTranslator = (String) properties
                        .get(brokerAddress.replaceAll(":", "-")
                ...
                if ((notificationTranslator != null)
                    ...
                    this.brokerSpecificNotificationTranslatorClasses
                            .put(brokerAddress, notificationTranslator);

                // check not null or empty
                if ((stateTranslator != null) && (!stateTranslator.isEmpty()))
                    // store the broker-specific state translator
                    this.brokerSpecificStateTranslatorClasses.put(brokerAddress,
                            stateTranslator);
            }
    ...
    /**
     * Called if the service configuration is changed.
     * 
     * @param context
     *            The updated {@link BundleContext} instance.
     */
    ...
    private void initClients()
    {
        ...
        for (String brokerAddress : toRemove)
        {
            ...
            this.broker2Client.remove(brokerAddress);
        }
        ...
        for (String brokerAddress : this.brokerAddresses)
        {
            ...
            if (this.broker2Client.get(brokerAddress) == null)
            {
                ...
                MqttAsyncDispatcher client = new MqttAsyncDispatcher(
                        "tcp://" + brokerAddress, UUID.randomUUID().toString(),
                        null, null, true, this.logger);
